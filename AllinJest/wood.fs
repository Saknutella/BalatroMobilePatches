...
// ❌ 删除这行全局初始化
// vec4 wood_color = vec4(102.0, 66.3, 33.15, 0.0) / (255.0 + wood.r);
...
vec4 dissolve_mask(vec4 tex, vec2 texture_coords, vec2 uv)
{
    ...
    // Smoothstep-like interpolation of dissolve ranging beyond 0..1 to avoid pause at extremes
